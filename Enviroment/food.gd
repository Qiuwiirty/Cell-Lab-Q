...
@export var nutrition = 1.152 #Max is 1.152
...
func _ready() -> void:
	var mods = nutrition / 1.152
	$CollisionShape2D.scale = Vector2(mods, mods)
	$MeshInstance2D.scale = Vector2(mods, mods)
	$MeshInstance2D.modulate = Color(1.0, 1.0 - (coating / 1.152), 1.0 - (coating / 1.152), 1.0)
